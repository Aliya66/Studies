...
|[Analysis of user behavior in a mobile application](https://github.com/Aliya66/Studies/tree/main/Testing%20hypotheses)| The goal is to study the sales funnel, the results of an A/A/B-test to change the font in the application|Pandas, SciPy, Math, Plotly.graph_objs
